...
class Manager(Employee):
    ...
    def manage_project(self):
        return f"{self.name} управление проектом в отделе {self.department}."
...
class Technician(Employee):
    ...
    def perform_maintenance(self):
        return f"{self.name} тех. обслуживание в отделе {self.specialization}."
...
employee = Employee("Bond", "007")
manager = Manager("james", "18726", "Ad")
technician = Technician("Anton", "18727", "Support")
tech_manager = TechManager("Daria", "18728", "AI", "Machine learning")
